...
private struct PixelPetSpriteView: View {
    ...
    private var shellBlocks: [PixelBlock] {
        ...
        return [
            .init(8, 1, 4, 1, PaguroTheme.outline),
            .init(7, 2, 6, 1, PaguroTheme.outline),
            .init(6, 3, 8, 1, PaguroTheme.outline),
            .init(5, 4, 9, 1, PaguroTheme.outline),
            .init(5, 5, 10, 1, PaguroTheme.outline),
            .init(4, 6, 10, 1, PaguroTheme.outline),
            .init(4, 7, 10, 1, PaguroTheme.outline),
            .init(4, 8, 9, 1, PaguroTheme.outline),
            .init(5, 9, 9, 1, PaguroTheme.outline),
            .init(5, 10, 8, 1, PaguroTheme.outline),
            .init(6, 11, 7, 1, PaguroTheme.outline),
            .init(7, 12, 5, 1, PaguroTheme.outline),
            .init(8, 13, 4, 1, PaguroTheme.outline),
            .init(8, 14, 3, 1, PaguroTheme.outline),
            .init(8, 2, 3, 1, shellBase),
            .init(7, 3, 5, 1, shellBase),
            .init(6, 4, 7, 1, shellBase),
            .init(6, 5, 8, 1, shellBase),
            .init(5, 6, 8, 1, shellBase),
            .init(5, 7, 9, 1, shellBase),
            .init(5, 8, 8, 1, shellBase),
            .init(6, 9, 7, 1, shellBase),
            .init(6, 10, 6, 1, shellBase),
            .init(7, 11, 5, 1, shellBase),
            .init(8, 12, 3, 1, shellBase),
            .init(8, 13, 3, 1, shellBase),
            .init(10, 4, 2, 1, shellAccent),
            .init(10, 5, 2, 2, shellAccent),
            .init(8, 6, 1, 3, shellAccent),
            .init(7, 8, 3, 1, shellAccent),
            .init(9, 9, 2, 2, shellAccent),
